...
S3_LOCAL_OSM_URL = "https://mkumard.synology.me/osm/db.tar.xz"
...
def is_local_osm_installed():
  api = overpy.Overpass()
  #https://www.openstreetmap.org/way/30023440 #phx
  #https://www.openstreetmap.org/way/443928591 #tw
  #https://www.openstreetmap.org/way/147221754 #fla
  q = """
      way(30023440);
      (._;>;);
      out;
