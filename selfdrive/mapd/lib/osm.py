...
from selfdrive.mapd.lib.helpers import is_local_osm_installed, OSM_VERSION, OSM_QUERY
...
class OSM():
  def __init__(self):
    ...
    self.areas = None
    self.osm_local_db_enabled = _LOCAL_OSM and Params().get_bool("OsmLocalDb")
