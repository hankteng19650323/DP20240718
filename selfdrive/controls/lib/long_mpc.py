...
class LongitudinalMpc():
  ...
  def dynamic_follow(self, CS):
    ...
    if self.df_profile == DF_PROFILE_LONG:
      y_dist = [1.2134, 1.2746, 1.3378, 1.3843, 1.4307, 1.4737, 1.5127, 1.5496, 1.6701, 1.8021, 1.8411, 1.8831, 1.98]  # TRs
      profile_mod_pos = [0.85, 0.9025, 0.815, 0.55]
      ...
      y_dist = [1.2913, 1.3111, 1.2512, 1.2442, 1.2306, 1.2212, 1.2175, 1.1977, 1.0963, 0.9435, 0.9067, 0.8749]
      profile_mod_pos = [1.0, 1.375, 2.99, 3.8]
