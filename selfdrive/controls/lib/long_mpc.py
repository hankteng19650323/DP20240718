...
class LongitudinalMpc():
  ...
  def dynamic_follow(self, CS):
    ...
    if self.df_profile == DF_PROFILE_LONG:
      y_dist = [1.6688, 1.5566, 1.5333, 1.5222, 1.5111, 1.6137, 1.6327, 1.7777, 1.8888, 1.9999, 2.0, 2.1, 2.2]  # TRs
      profile_mod_pos = [0.99, 0.9025, 0.815, 0.55]
      profile_mod_neg = [0.5, 0.78, 0.882, 1.187]
    ...
    sng_TR = 1.6   # reacceleration stop and go TR
