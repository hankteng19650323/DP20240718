...
_AP_CRUISE_MAX_V = [1.4, 1.3, 1.2, .5, .25]
_AP_CRUISE_MAX_V_ECO = [1.3, 1.2, 1.1, 0.4, 0.1]
_AP_CRUISE_MAX_V_SPORT = [2.0, 2.5, 2.0, 1.0, 1.0]
_AP_CRUISE_MAX_V_FOLLOWING = [1.6, 1.4, 1.1, .5, .2]
