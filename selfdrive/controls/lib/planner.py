...
_AP_CRUISE_MAX_V = [1.4, 1.3, 1.1, .5, .3]
_AP_CRUISE_MAX_V_ECO = [1.25, 1.1, 0.75, 0.35, 0.15]
_AP_CRUISE_MAX_V_SPORT = [1.5, 1.4, 1.2, 0.7, 0.4]
_AP_CRUISE_MAX_V_FOLLOWING = [1.3, 1.2, 0.85, .55, .25]
