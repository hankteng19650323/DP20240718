...
_A_CRUISE_MIN_V_ECO = [-0.7, -0.6, -0.5, -0.4, -0.2]
...
# make sure these accelerations are smaller than mpc limits
_A_CRUISE_MAX_V = [1.4, 1.3, 1.1, .5, .3]
_A_CRUISE_MAX_V_ECO = [1.25, 1.1, 0.75, 0.35, 0.15]
_A_CRUISE_MAX_V_SPORT = [1.5, 1.4, 1.2, 0.7, 0.3]
_A_CRUISE_MAX_V_FOLLOWING = [1.3, 1.2, 0.85, .4, .2]
