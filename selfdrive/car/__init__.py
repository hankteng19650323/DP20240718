...
def apply_std_steer_torque_limits(apply_torque, apply_torque_last, driver_torque, LIMITS, steer_max_override = None, is_hkg=False):

  # limits due to driver torque
  steer_max = LIMITS.STEER_MAX
  if steer_max_override is not None:
    steer_max = steer_max_override
  if is_hkg:
